...
def create_ui():
    ...
    w = Canvas(root, width=450, height=120)
    w.place(x=40, y=150)

    w.create_line(0, 0, 450, 0, fill="#000", width=5)
    w.create_line(0, 0, 0, 120, fill="#000", width=5)
    w.create_line(0, 120, 450, 120, fill="#000", width=1)
    w.create_line(450, 120, 450, 0, fill="#000", width=1)

    w.create_line(150, 0, 150, 120, fill="#000", width=1)
    w.create_line(300, 0, 300, 120, fill="#000", width=1)
    ...
    Label(root, text='3000').place(x=100, y=200)
    Label(root, text='5000').place(x=100, y=240)
    ...
    Button(root, text='授权', width=10, command=lambda: btn_logic.auth_btn_main(ui_global, '3000')).place(x=380, y=195)
    Button(root, text='授权', width=10, command=lambda: btn_logic.auth_btn_main(ui_global, '5000')).place(x=380, y=235)
